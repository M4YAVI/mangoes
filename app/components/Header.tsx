...
export default function Header() {
  ...
  return (
    <header className="px-6 lg:px-12 py-2 flex items-center justify-between relative z-50 bg-brand-cream/80 backdrop-blur-md sticky top-0 border-b border-[#1B330F]/5">
      {/* Logo & Brand */}
      ...
      <div className="flex items-center space-x-4 lg:space-x-6 text-[#2E4D25]">
        <button className="hidden sm:block hover:text-[#DE8A24] transition-colors">
